...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/21 07:24:37 by nivachir          #+#    #+#             */
/*   Updated: 2024/04/23 16:25:15 by nivachir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (b)
	{
		...
		while (current_a)
		{
			if (current_a->value > b->value
				&& current_a->value < best_fit)
			{
				best_fit = current_a->value;
				target_node = current_a;
			}
			current_a = current_a->next;
		}
		if (LONG_MAX == best_fit)
